...
long* insertion_sort(long*& array, const int size, bool(*compare)(long,long));
long* bubble_sort(long*& array, const int size, bool(*compare)(long,long));
...
int main(){
	...
	if(arrayDesordenadoInsertion && arrayDesordenadoBubble && arrayOrdenadoDescendenteInsertion && arrayOrdenadoDescendenteBubble){		
			...
			bubble_sort(arrayOrdenadoDescendenteBubble, size, menor);
